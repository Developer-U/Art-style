...
<head>
	...
	<noscript>
		<div><img src="https://mc.yandex.ru/watch/98351087" style="position:absolute; left:-9999px;" alt="" /></div>
	</noscript>
	<!-- /Yandex.Metrika counter -->
</head>
...
<body <?php body_class(); ?> <?php echo blocksy_body_attr() ?>>
	...
	<header class="header">
		...
		<div class="header__under header-under d-flex">
			<div class="ct-container d-flex align-items-center justify-content-between flex-wrap">
				<?php if ($region) {
					echo '<p class="header-under__address col-auto">' . $region . '</p>';
				} ?>
				...
				<button data-popup-open="call-popup" class="button red-btn col-auto short">заказать звонок</button>
			</div>
		</div>
	</header>