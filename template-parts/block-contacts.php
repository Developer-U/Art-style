            ...
            <div class="contacts-wrap__item left contacts-item d-grid">
                ...
                <?php if (have_rows('new_phone_block')) { ?>
                    ...
                    <div class="contacts-item__box">
                        ...
                        <?php if (have_rows('new_phone_block')): ?>
                            <?php while (have_rows('new_phone_block')):
                                the_row();
                ...
                if ($address) { ?>
                    <ul class="contacts-item__list d-flex flex-column flex-sm-row align-items-sm-center">
                        <li class="contacts-item__item name address">Адрес</li>
                        <li class="contacts-item__item value"><?php echo $address; ?></li>
                    </ul>
                <?php }
                    ...
                    <ul class="contacts-item__list d-flex flex-column flex-sm-row align-items-sm-center">
                        ...
                        <li class="contacts-item__item value">
                            <a class="contacts-item__link"
                                href="https://api.whatsapp.com/send?phone=<?php echo $socials['whatsapp']; ?>"
                                target="_blank" class="social__link whatsapp">
